...
function CostumeSwap()
    if World == 0x07 then --Agrabah
        WriteString(Obj0+0x1b70,'W_EX010_Aladin\0')
    elseif World == 0x10 then --Port Royal
        WriteString(Obj0+0x1b70,'W_EX010_Jack\0')
    elseif World == 0x02 then --Twilight Town
        WriteString(Obj0+0x1b70,'W_EX010_Twilight\0')
    elseif World == 0x04 then --Hollow bastion
        WriteString(Obj0+0x1b70,'W_EX010_Hollow\0')
    elseif World == 0x05 then --Beasts Castle
        WriteString(Obj0+0x1b70,'W_EX010_Beast\0')
    elseif World == 0x06 then --olymp
        WriteString(Obj0+0x1b70,'W_EX010_Herc\0')
    elseif World == 0x08 then --Mulan
        WriteString(Obj0+0x1b70,'W_EX010_Mulan\0')
    elseif World == 0x09 then --100acer
        WriteString(Obj0+0x1b70,'W_EX010_puh\0')
    elseif World == 0x0a then --Pride Lands
        WriteString(Obj0+0x1b70,'W_EX010_Lion\0')
    elseif World == 0x0b then --Atlantica
        WriteString(Obj0+0x1b70,'W_EX010_atlantica\0')
    elseif World == 0x0c then --Disney Castle
        WriteString(Obj0+0x1b70,'W_EX010_Mickey\0')
    elseif World == 0x12 then --Final world
        WriteString(Obj0+0x1b70,'W_EX010_Final\0')
    else --Revert costume changes
        WriteString(Obj0+0x1b70,'W_EX010_10\0')
    end
end